...
// MegaRAID discovers physical drives behind MegaRAID/PERC controllers
// using storcli or perccli.
type MegaRAID struct {
	rc ports.RAIDController
}

var _ service.PhysicalDriveDiscoverer = &MegaRAID{}
...
func (d *MegaRAID) DiscoverPhysicalDrives() ([]*domain.DiscoveredPhysicalDrive, error) {
	...
	for _, ctrl := range controllers {
		...
		if err != nil {
			return nil, errors.Wrapf(err, "failed to list physical drives for MegaRAID controller %d", ctrl.Metadata.ID)
		}
